...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "The system has already been installed. Please refresh the page or return to the workspace homepage."
    code = 403
...
class NotSetupError(BaseHTTPException):
    ...
    description = (
        "The system has not been initialized and installed yet. "
