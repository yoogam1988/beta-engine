...
/**
 * Forum command - Opens the internal help entry.
 */
export const forumCommand: SlashCommandHandler<ForumDeps> = {
  name: 'forum',
  description: 'Open internal help',
  mode: 'direct',

  // Direct execution function
  execute: () => {
    const url = '/help/community'
  ...
  async search(args: string, locale: string = 'en') {
    ...
    return [{
      ...
      description: i18n.t('gotoAnything.actions.feedbackDesc', { ns: 'app', lng: locale }) || 'Open internal help',
      ...
      data: { command: 'navigation.forum', args: { url: '/help/community' } },
    }]
  },
  ...
  register(_deps: ForumDeps) {
    registerCommands({
      'navigation.forum': async (args) => {
        const url = args?.url || '/help/community'
        window.open(url, '_blank', 'noopener,noreferrer')
      },
    })
  },
