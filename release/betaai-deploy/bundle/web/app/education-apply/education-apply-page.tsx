...
import AtomFlowLogo from '../components/base/logo/atomflow-logo'
    ...
    <div className="fixed inset-0 z-[31] overflow-y-auto bg-background-body p-6">
      <div className="mx-auto w-full max-w-[1408px] rounded-2xl border border-effects-highlight bg-background-default-subtle">
        ...
        <div className="mt-[-349px] box-content flex h-7 items-center justify-between p-6">
          <AtomFlowLogo size="large" style="monochromeWhite" />
        </div>
...
&nbsp;
                    <a href="/terms" target="_blank" className="text-text-secondary hover:underline">{t('form.terms.desc.termsOfService', { ns: 'education' })}</a>
&nbsp;
              {t('form.terms.desc.and', { ns: 'education' })}
&nbsp;
                    <a href="/privacy" target="_blank" className="text-text-secondary hover:underline">{t('form.terms.desc.privacyPolicy', { ns: 'education' })}</a>
