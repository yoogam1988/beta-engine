# Variables
DOCKER_REGISTRY=betaai
WEB_IMAGE=$(DOCKER_REGISTRY)/betaai-web
API_IMAGE=$(DOCKER_REGISTRY)/betaai-api
VERSION=latest
...
prepare-docker:
	...
	@cd docker && docker compose -f docker-compose.middleware.yaml --env-file middleware.env -p betaai-middlewares-dev up -d
...
dev-clean:
	...
	@cd docker && docker compose -f docker-compose.middleware.yaml --env-file middleware.env -p betaai-middlewares-dev down
