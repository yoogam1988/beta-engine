...
// AtomFlow 配置开关
const ATOMFLOW_HIDE_API_ACCESS = process.env.NEXT_PUBLIC_ATOMFLOW_HIDE_API_ACCESS === '1'
...
const AppDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  ...
  const getNavigationConfig = useCallback((appId: string, isCurrentWorkspaceEditor: boolean, mode: AppModeEnum) => {
    // AtomFlow: 简化模式下隐藏 API 访问入口
    const shouldShowApiAccess = !ATOMFLOW_HIDE_API_ACCESS
