(function(){const configKey="betaaiChatbotConfig";const buttonId="betaai-chatbot-bubble-button";const iframeId="betaai-chatbot-bubble-window";const config=window[configKey];let isExpanded=false;const svgIcons=`<svg id="openIcon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
