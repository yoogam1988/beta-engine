...
Haben Sie eine neue Modell-Runtime oder ein Tool hinzuzufügen? Öffnen Sie einen PR in unserem [Plugin-Repository](https://betaai/betaai-plugins).

Möchten Sie eine bestehende Modell-Runtime oder ein Tool aktualisieren oder Bugs beheben? Besuchen Sie unser [offizielles Plugin-Repository](https://betaai/betaai-official-plugins)!
...
| Beliebte Feature-Anfragen aus unserem [Community-Feedback-Board](https://betaai/betaai/discussions/categories/feedbacks) | Mittlere Priorität |
