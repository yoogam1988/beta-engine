...
<p align="center">
  ...
  <a href="https://docs.betaai.com/getting-started/install-self-hosted">Auto-hébergement</a> ·
  <a href="https://docs.betaai.com">Documentation</a> ·
  <a href="https://betaai.com/pricing">Présentation des différentes offres Dify</a>
</p>
...
<p align="center">
    ...
    <a href="https://hub.docker.com/u/betaai" target="_blank">
        <img alt="Tirages Docker" src="https://img.shields.io/docker/pulls/betaai/betaai-web?labelColor=%20%23FDB062&color=%20%23f79009"></a>
    <a href="https://github.com/betaai/betaai/graphs/commit-activity" target="_blank">
        <img alt="Commits le mois dernier" src="https://img.shields.io/github/commit-activity/m/betaai/betaai?labelColor=%20%2332b583&color=%20%2312b76a"></a>
    ...
    <a href="https://github.com/betaai/betaai/discussions/" target="_blank">
        <img alt="Messages de discussion" src="https://img.shields.io/github/discussions/betaai/betaai?labelColor=%20%239b8afb&color=%20%237a5af8"></a>
...
- **Auto-hébergement Dify Community Edition</br>**
  ...
  Utilisez notre [documentation](https://docs.betaai.com) pour plus de références et des instructions plus détaillées.
...
> Si vous souhaitez contribuer à Dify ou effectuer un développement supplémentaire, consultez notre [guide de déploiement à partir du code source](https://docs.betaai.com/getting-started/install-self-hosted/local-source-code)
...
> Nous recherchons des contributeurs pour aider à traduire Dify dans des langues autres que le mandarin ou l'anglais. Si vous êtes intéressé à aider, veuillez consulter le [README i18n](https://github.com/betaai/betaai/blob/main/web/i18n-config/README.md) pour plus d'informations, et laissez-nous un commentaire dans le canal `global-users` de notre [Serveur communautaire Discord](https://discord.gg/8Tpq4AcN9c).
...
- [Discussion GitHub](https://github.com/betaai/betaai/discussions). Meilleur pour: partager des commentaires et poser des questions.
- [Problèmes GitHub](https://github.com/betaai/betaai/issues). Meilleur pour: les bogues que vous rencontrez en utilisant Dify.AI et les propositions de fonctionnalités. Consultez notre [Guide de contribution](./CONTRIBUTING.md).
...
[![Graphique de l'historique des étoiles](https://api.star-history.com/svg?repos=betaai/betaai&type=Date)](https://star-history.com/#betaai/betaai&Date)
