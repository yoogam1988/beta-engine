...
Vous avez un nouveau modèle ou un nouvel outil à ajouter ? Ouvrez une PR dans notre [dépôt de plugins](https://betaai/betaai-plugins) et montrez-nous ce que vous avez créé.

Vous devez mettre à jour un modèle existant, un outil ou corriger des bugs ? Rendez-vous sur notre [dépôt officiel de plugins](https://betaai/betaai-official-plugins) et faites votre magie !
...
| Demandes populaires de fonctionnalités de notre [tableau de feedback communautaire](https://betaai/betaai/discussions/categories/feedbacks) | Priorité Moyenne |
