...
추가할 새로운 모델 런타임이나 도구가 있나요? 우리의 [플러그인 저장소](https://betaai/betaai-plugins)에 PR을 열고 당신이 만든 것을 보여주세요.

기존 모델 런타임, 도구를 업데이트하거나 버그를 수정해야 하나요? 우리의 [공식 플러그인 저장소](https://betaai/betaai-official-plugins)로 가서 당신의 마법을 펼치세요!
...
| 우리의 [커뮤니티 피드백 보드](https://betaai/betaai/discussions/categories/feedbacks)에서 인기 있는 기능 요청 | 중간 우선순위 |
