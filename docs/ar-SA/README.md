...
<p align="center">
  ...
  <a href="https://docs.betaai.com/getting-started/install-self-hosted">الاستضافة الذاتية</a> ·
  <a href="https://docs.betaai.com">التوثيق</a> ·
  <a href="https://betaai.com/pricing">نظرة عامة على منتجات Dify</a>
</p>
...
- **استضافة ذاتية لنسخة المجتمع Dify</br>**
  ...
  استخدم [توثيقنا](https://docs.betaai.com) للمزيد من المراجع والتعليمات الأعمق.
...
![نجمنا](https://github.com/betaai/betaai/assets/13230914/b823edc1-6388-4e25-ad45-2f6b187adbb4)
...
> إذا كنت ترغب في المساهمة في Dify أو القيام بتطوير إضافي، فانظر إلى [دليلنا للنشر من الشفرة (code) المصدرية](https://docs.betaai.com/getting-started/install-self-hosted/local-source-code)
...
لأولئك الذين يرغبون في المساهمة، انظر إلى [دليل المساهمة](https://github.com/betaai/betaai/blob/main/CONTRIBUTING.md) لدينا.
في الوقت نفسه، يرجى النظر في دعم Dify عن طريق مشاركته على وسائل التواصل الاجتماعي وفي الفعاليات والمؤتمرات.

> نحن نبحث عن مساهمين لمساعدة في ترجمة Dify إلى لغات أخرى غير اللغة الصينية المندرين أو الإنجليزية. إذا كنت مهتمًا بالمساعدة، يرجى الاطلاع على [README للترجمة](https://github.com/betaai/betaai/blob/main/web/i18n-config/README.md) لمزيد من المعلومات، واترك لنا تعليقًا في قناة `global-users` على [خادم المجتمع على Discord](https://discord.gg/8Tpq4AcN9c).
...
- [مناقشة GitHub](https://github.com/betaai/betaai/discussions). الأفضل لـ: مشاركة التعليقات وطرح الأسئلة.
- [المشكلات على GitHub](https://github.com/betaai/betaai/issues). الأفضل لـ: الأخطاء التي تواجهها في استخدام Dify.AI، واقتراحات الميزات. انظر [دليل المساهمة](https://github.com/betaai/betaai/blob/main/CONTRIBUTING.md).
