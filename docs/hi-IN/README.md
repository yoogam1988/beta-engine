...
<p align="center">
  <a href="https://cloud.betaai.com">Dify Cloud</a> ·
  <a href="https://docs.betaai.com/getting-started/install-self-hosted">स्व-होस्टिंग</a> ·
  <a href="https://docs.betaai.com">दस्तावेज़ीकरण</a> ·
  <a href="https://betaai.com/pricing">Dify संस्करण का अवलोकन</a>
</p>

<p align="center">
    <a href="https://dify.ai" target="_blank">
        <img alt="Static Badge" src="https://img.shields.io/badge/Product-F04438"></a>
    <a href="https://betaai.com/pricing" target="_blank">
        <img alt="Static Badge" src="https://img.shields.io/badge/free-pricing?logo=free&color=%20%23155EEF&label=pricing&labelColor=%20%23528bff"></a>
    <a href="https://discord.gg/FngNHpbcY7" target="_blank">
        <img src="https://img.shields.io/discord/1082486657678311454?logo=discord&labelColor=%20%235462eb&logoColor=%20%23f5f5f5&color=%20%235462eb"
            alt="chat on Discord"></a>
    <a href="https://reddit.com/r/betaai" target="_blank">  
    ...
    <a href="https://hub.docker.com/u/betaai" target="_blank">
        <img alt="Docker Pulls" src="https://img.shields.io/docker/pulls/betaai/betaai-web?labelColor=%20%23FDB062&color=%20%23f79009"></a>
    <a href="https://github.com/betaai/betaai/graphs/commit-activity" target="_blank">
        <img alt="Commits last month" src="https://img.shields.io/github/commit-activity/m/betaai/betaai?labelColor=%20%2332b583&color=%20%2312b76a"></a>
    <a href="https://github.com/betaai/betaai/" target="_blank">
        <img alt="Issues closed" src="https://img.shields.io/github/issues-search?query=repo%3Alanggenius%2Fdify%20is%3Aclosed&label=issues%20closed&labelColor=%20%237d89b0&color=%20%235d6b98"></a>
    <a href="https://github.com/betaai/betaai/discussions/" target="_blank">
        <img alt="Discussion posts" src="https://img.shields.io/github/discussions/betaai/betaai?labelColor=%20%239b8afb&color=%20%237a5af8"></a>
...
यदि आपको Dify सेटअप करते समय कोई समस्या आती है, तो कृपया हमारे [FAQ](https://docs.betaai.com/getting-started/install-self-hosted/faqs) को देखें। यदि फिर भी समस्या बनी रहती है, तो [the community and us](#community--contact) से संपर्क करें।

> यदि आप Dify में योगदान देना चाहते हैं या अतिरिक्त विकास करना चाहते हैं, तो हमारे [guide to deploying from source code](https://docs.betaai.com/getting-started/install-self-hosted/local-source-code) को देखें।
...
कई इन्फ़रेंस प्रदाताओं और स्व-होस्टेड समाधानों से सैकड़ों स्वामित्व / मुक्त-स्रोत LLMs के साथ सहज एकीकरण, जिसमें GPT, Mistral, Llama3, और कोई भी OpenAI API-संगत मॉडल शामिल हैं। समर्थित मॉडल प्रदाताओं की पूरी सूची [here](https://docs.betaai.com/getting-started/readme/model-providers) पर पाई जा सकती है।

![providers-v5](https://github.com/betaai/betaai/assets/13230914/5a17bdbe-097a-4100-8363-40255b70f6e3)
...
- **Dify कम्युनिटी संस्करण की स्व-होस्टिंग<br/>**\
  ...
  आगे के संदर्भों और विस्तृत निर्देशों के लिए हमारी [documentation](https://docs.betaai.com) देखें।
...
![star-us](https://github.com/betaai/betaai/assets/13230914/b823edc1-6388-4e25-ad45-2f6b187adbb4)
...
उपलब्ध सभी environment variables की पूरी सूची [here](https://docs.betaai.com/getting-started/install-self-hosted/environments) पर पाई जा सकती है।
...
> यदि आप सहायता करने में रुचि रखते हैं, तो अधिक जानकारी के लिए [i18n README](https://github.com/betaai/betaai/blob/main/web/i18n-config/README.md) देखें, और हमारे [Discord Community Server](https://discord.gg/8Tpq4AcN9c) के `global-users` चैनल में हमें संदेश दें।

## समुदाय और संपर्क (Community & contact)

- [GitHub Discussion](https://github.com/betaai/betaai/discussions) — सर्वोत्तम उपयोग के लिए: प्रतिक्रिया साझा करने और प्रश्न पूछने हेतु।
- [GitHub Issues](https://github.com/betaai/betaai/issues) — सर्वोत्तम उपयोग के लिए: Dify.AI का उपयोग करते समय आने वाली बग्स या फीचर सुझावों के लिए। देखें: [Contribution Guide](../../CONTRIBUTING.md)।
...
<a href="https://github.com/betaai/betaai/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=betaai/betaai" />
</a>

## स्टार इतिहास (Star history)

[![Star History Chart](https://api.star-history.com/svg?repos=betaai/betaai&type=Date)](https://star-history.com/#betaai/betaai&Date)
