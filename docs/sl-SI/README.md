...
<p align="center">
  ...
  <a href="https://docs.betaai.com/getting-started/install-self-hosted">Samostojno gostovanje</a> ·
  <a href="https://docs.betaai.com">Dokumentacija</a> ·
  <a href="https://betaai.com/pricing">Pregled ponudb izdelkov Dify</a>
</p>
...
Prosimo, glejte naša pogosta vprašanja [FAQ](https://docs.betaai.com/getting-started/install-self-hosted/faqs) če naletite na težave pri nastavitvi Dify. Če imate še vedno težave, se obrnite na [skupnost ali nas](#community--contact).

> Če želite prispevati k Difyju ali narediti dodaten razvoj, glejte naš vodnik za [uvajanje iz izvorne kode](https://docs.betaai.com/getting-started/install-self-hosted/local-source-code)
...
- **Self-hosting Dify Community Edition</br>**
  Hitro zaženite Dify v svojem okolju s tem [začetnim vodnikom](#quick-start) . Za dodatne reference in podrobnejša navodila uporabite našo [dokumentacijo](https://docs.betaai.com) .
...
Za tiste, ki bi radi prispevali kodo, si oglejte naš [vodnik za prispevke](https://github.com/betaai/betaai/blob/main/CONTRIBUTING.md). Hkrati vas prosimo, da podprete Dify tako, da ga delite na družbenih medijih ter na dogodkih in konferencah.
...
- [GitHub Discussion](https://github.com/betaai/betaai/discussions). Najboljše za: izmenjavo povratnih informacij in postavljanje vprašanj.
- [GitHub Issues](https://github.com/betaai/betaai/issues). Najboljše za: hrošče, na katere naletite pri uporabi Dify.AI, in predloge funkcij. Oglejte si naš [vodnik za prispevke](https://github.com/betaai/betaai/blob/main/CONTRIBUTING.md).
