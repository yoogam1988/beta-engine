...
Tem um novo modelo ou ferramenta para adicionar? Abra um PR em nosso [repositório de plugins](https://betaai/betaai-plugins) e mostre-nos o que você construiu.

Precisa atualizar um modelo existente, ferramenta ou corrigir alguns bugs? Vá para nosso [repositório oficial de plugins](https://betaai/betaai-official-plugins) e faça sua mágica!
...
| Solicitações populares de recursos do nosso [quadro de feedback da comunidade](https://betaai/betaai/discussions/categories/feedbacks) | Prioridade Média |
