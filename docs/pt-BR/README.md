...
<p align="center">
  ...
  <a href="https://docs.betaai.com/getting-started/install-self-hosted">Auto-hospedagem</a> ·
  <a href="https://docs.betaai.com">Documentação</a> ·
  <a href="https://betaai.com/pricing">Visão geral das edições do Dify</a>
</p>
...
- **Auto-hospedagem do Dify Community Edition</br>**
  ...
  Use nossa [documentação](https://docs.betaai.com) para referências adicionais e instruções mais detalhadas.
...
> Se você deseja contribuir com o Dify ou fazer desenvolvimento adicional, consulte nosso [guia para implantar a partir do código fonte](https://docs.betaai.com/getting-started/install-self-hosted/local-source-code).
...
> Estamos buscando contribuidores para ajudar na tradução do Dify para idiomas além de Mandarim e Inglês. Se você tiver interesse em ajudar, consulte o [README i18n](https://github.com/betaai/betaai/blob/main/web/i18n-config/README.md) para mais informações e deixe-nos um comentário no canal `global-users` em nosso [Servidor da Comunidade no Discord](https://discord.gg/8Tpq4AcN9c).
...
- [Discussões no GitHub](https://github.com/betaai/betaai/discussions). Melhor para: compartilhar feedback e fazer perguntas.
- [Problemas no GitHub](https://github.com/betaai/betaai/issues). Melhor para: relatar bugs encontrados no Dify.AI e propor novos recursos. Veja nosso [Guia de Contribuição](./CONTRIBUTING.md).
...
[![Gráfico de Histórico de Estrelas](https://api.star-history.com/svg?repos=betaai/betaai&type=Date)](https://star-history.com/#betaai/betaai&Date)
