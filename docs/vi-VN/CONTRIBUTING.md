...
Bạn có một model runtime hoặc công cụ mới thú vị để thêm vào? Mở PR trong [repo plugin](https://betaai/betaai-plugins) của chúng tôi và cho chúng tôi thấy những gì bạn đã xây dựng.

Cần cập nhật model runtime, công cụ hiện có hoặc sửa lỗi? Ghé thăm [repo plugin chính thức](https://betaai/betaai-official-plugins) và thực hiện phép màu của bạn!
...
| Yêu cầu tính năng phổ biến từ [bảng phản hồi cộng đồng](https://betaai/betaai/discussions/categories/feedbacks) | Ưu tiên trung bình |
