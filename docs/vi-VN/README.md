...
<p align="center">
  ...
  <a href="https://docs.betaai.com/getting-started/install-self-hosted">Tự triển khai</a> ·
  <a href="https://docs.betaai.com">Tài liệu</a> ·
  <a href="https://betaai.com/pricing">Tổng quan các lựa chọn sản phẩm Dify</a>
</p>
...
<p align="center">
    ...
    <a href="https://github.com/betaai/betaai/graphs/commit-activity" target="_blank">
        <img alt="Commits tháng trước" src="https://img.shields.io/github/commit-activity/m/betaai/betaai?labelColor=%20%2332b583&color=%20%2312b76a"></a>
    ...
    <a href="https://github.com/betaai/betaai/discussions/" target="_blank">
        <img alt="Bài thảo luận" src="https://img.shields.io/github/discussions/betaai/betaai?labelColor=%20%239b8afb&color=%20%237a5af8"></a>
...
- **Tự triển khai Dify Community Edition</br>**
  ...
  Sử dụng [tài liệu](https://docs.betaai.com) của chúng tôi để tham khảo thêm và nhận hướng dẫn chi tiết hơn.
...
> Nếu bạn muốn đóng góp cho Dify hoặc phát triển thêm, hãy tham khảo [hướng dẫn triển khai từ mã nguồn](https://docs.betaai.com/getting-started/install-self-hosted/local-source-code) của chúng tôi
...
- [Thảo luận GitHub](https://github.com/betaai/betaai/discussions). Tốt nhất cho: chia sẻ phản hồi và đặt câu hỏi.
- [Vấn đề GitHub](https://github.com/betaai/betaai/issues). Tốt nhất cho: lỗi bạn gặp phải khi sử dụng Dify.AI và đề xuất tính năng. Xem [Hướng dẫn Đóng góp](./CONTRIBUTING.md) của chúng tôi.
...
[![Biểu đồ Lịch sử Yêu thích](https://api.star-history.com/svg?repos=betaai/betaai&type=Date)](https://star-history.com/#betaai/betaai&Date)
