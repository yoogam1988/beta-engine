...
<p align="center">
  ...
  <a href="https://docs.betaai.com/getting-started/install-self-hosted">Self-hosting</a> ·
  <a href="https://docs.betaai.com">Documentation</a> ·
  <a href="https://betaai.com/pricing">Dify product editions</a>
</p>
...
- **Self-hosting Dify Community Edition</br>**
  ...
  Use our [documentation](https://docs.betaai.com) for further references and more in-depth instructions.
...
> If you'd like to contribute to Dify or do additional development, refer to our [guide to deploying from source code](https://docs.betaai.com/getting-started/install-self-hosted/local-source-code)
...
For those who'd like to contribute code, see our [Contribution Guide](https://github.com/betaai/betaai/blob/main/CONTRIBUTING.md).
At the same time, please consider supporting Dify by sharing it on social media and at events and conferences.

> We are looking for contributors to help with translating Dify to languages other than Mandarin or English. If you are interested in helping, please see the [i18n README](https://github.com/betaai/betaai/blob/main/web/i18n-config/README.md) for more information, and leave us a comment in the `global-users` channel of our [Discord Community Server](https://discord.gg/8Tpq4AcN9c).
...
- [GitHub Discussion](https://github.com/betaai/betaai/discussions). Best for: sharing feedback and asking questions.
- [GitHub Issues](https://github.com/betaai/betaai/issues). Best for: bugs you encounter using Dify.AI, and feature proposals. See our [Contribution Guide](https://github.com/betaai/betaai/blob/main/CONTRIBUTING.md).
